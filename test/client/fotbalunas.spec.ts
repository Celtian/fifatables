import { FifaTablesFotbalunasClient } from '../../lib/clients/fotbalunas';
...
describe('FifaTablesFotbalunasClient', () => {
  let client: FifaTablesFotbalunasClient;

  beforeEach(() => {
    client = new FifaTablesFotbalunasClient();
  });
  ...
  describe('league', () => {
    beforeEach(() => {
      const handleSpy = jest.spyOn(FifaTablesFotbalunasClient.prototype as any, 'fetchPage');
