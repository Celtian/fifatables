import { FifaTablesSoccerwayClient } from '../../lib/clients/soccerway';
...
describe('FifaTablesSoccerwayClient', () => {
  let client: FifaTablesSoccerwayClient;

  beforeEach(() => {
    client = new FifaTablesSoccerwayClient(5);
  });
  ...
  describe('league', () => {
    beforeEach(() => {
      const handleSpy = jest.spyOn(FifaTablesSoccerwayClient.prototype as any, 'fetchPage');
  ...
  describe('team', () => {
    beforeEach(() => {
      ...
      const handlePlayerSpy = jest.spyOn(FifaTablesSoccerwayClient.prototype as any, 'player');
