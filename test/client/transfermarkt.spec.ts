import { FifaTablesTransfermarktClient } from '../../lib/clients/transfermarkt';
import { LEAGUE_DATA, LEAGUE_HTML } from '../mocks/transfermarkt/league';
import { TEAM_DATA, TEAM_HTML } from '../mocks/transfermarkt/team';

describe('FifaTablesTransfermarktClient', () => {
  let client: FifaTablesTransfermarktClient;

  beforeEach(() => {
    client = new FifaTablesTransfermarktClient();
  });
  ...
  describe('league', () => {
    beforeEach(() => {
      const handleSpy = jest.spyOn(FifaTablesTransfermarktClient.prototype as any, 'fetchPage');
