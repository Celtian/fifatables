import { FifaTablesEurofotbalClient } from '../../lib/clients/eurofotbal';
import { LEAGUE_DATA, LEAGUE_HTML } from '../mocks/eurofotbal/league';
import { TEAM_DATA, TEAM_HTML } from '../mocks/eurofotbal/team';

describe('FifaTablesEurofotbalClient', () => {
  let client: FifaTablesEurofotbalClient;

  beforeEach(() => {
    client = new FifaTablesEurofotbalClient();
  });
  ...
  describe('league', () => {
    beforeEach(() => {
      const handleSpy = jest.spyOn(FifaTablesEurofotbalClient.prototype as any, 'fetchPage');
